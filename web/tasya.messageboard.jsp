...
<%
    Messager messager = new Messager("Tasya"); 
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        if (pengirim != null && !pengirim.trim().isEmpty() && pesan != null && !pesan.trim().isEmpty()) {
            ...
            response.sendRedirect("tasya.messageboard.jsp");
            return;
        }
    }
    ...
    RequestDispatcher dispatcher = request.getRequestDispatcher("tasya.messageboard.view.jsp");
