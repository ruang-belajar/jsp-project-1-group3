        ...
        <div class="container my-5">
            <div class="message-card card shadow-lg">
                <div class="card-header bg-dark text-white p-4 text-center">
                    <img src="raffi.webp" class="rounded-circle profile-pic" alt="Foto ${pemilik}">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="post" action="raffi.messageboard.jsp">
                        <div class="mb-3">
                    ...
                    <div class="list-group">
                        <c:choose>
                            <c:when test="${!empty list}">
                                <c:forEach items="${list}" var="row"><div class="list-group-item list-group-item-action">
