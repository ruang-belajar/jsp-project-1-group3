        ...
        <div class="container my-5">
            <div class="message-card card shadow-lg">
                <div class="card-header bg-dark text-white p-4 text-center">
                    <img src="ridwan.webp" class="rounded-circle profile-pic" alt="Foto ${pemilik}">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="post" action="ridwan.messageboard.jsp">
                        <div class="mb-3">
                        ...
                        <c:choose>
                            <c:when test="${!empty list}">
                                <c:forEach items="${list}" var="row">
                                    <div class="list-group-item list-group-item-action"><div class="d-flex w-100 justify-content-between">
                            ...
                            <c:otherwise>
                                <p class="text-center text-muted">Belum ada pesan. Jadilah yang pertama!</p>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
